...
<head>
  ...
  <title>{{ config('site.title')  }} 网站后台</title>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     fixed layout. -->
            ...
            @yield('content')
                        ...
                        @can('@backend-collection-read')
                            <li>
                                <a href="#"><i class="fa fa-sitemap fa-fw"></i> 子站设置<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    @can('@backend-collection-write')
                                        <li>
